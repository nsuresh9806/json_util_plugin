...
public class JsonUtilityActionLombok extends AnAction {

    private static final Logger log = LoggerFactory.getLogger(JsonUtilityActionLombok.class);
            ...
            if (editor != null) {
                ...
                if (!fileContent.isBlank() || !fileContent.isEmpty()) {
                    if (jsonUtility.isValidJson(fileContent)) {
                        ...
                        String javaClassContent = jsonUtility.generateLombokJavaClassFromJson(formattedJson, capitalizedFileName);
